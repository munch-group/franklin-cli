...
- <i class="bi bi-box-seam"></i> [Developer Guide](pages/developer_guide.qmd) - Start contributing
- <i class="bi bi-box-seam"></i> [GitHub](https://github.com/munch-group/franklin) - Star the project
- <i class="bi bi-box-seam"></i> [Plugins](pages/developer_guide.qmd#plugin-development) - Extend Franklin
