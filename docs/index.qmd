...
```bash
conda install -c munch-group franklin-educator
...
### 📦 **Smart Dependencies**
Automatic dependency detection from notebook imports. Pixi package manager ensures reproducible environments across all platforms.
