...
We have built native installers for both macOS and Windows to make installation as easy as possible. Before installing Franklin, the installer will download and install the following dependencies if they are not available available on your computer:
...
window.InstallerWidget = (function() {
    ...
    const installerConfig = {
        windows: {
            ...
            url: 'https://munch-group.org/franklin/installers/Franklin-Installer-Windows.exe',
        ...
        macos: {
            ...
            url: 'https://munch-group.org/franklin/installers/Franklin-Installer-macOS.dmg',
            filename: 'Franklin-Installer-macOS.dmg',
            size: '52.1 MB',
            version: '1.0.0'
        },
        linux: {
            url: 'https://munch-group.org/franklin/installers/Franklin-Installer-Linux.AppImage',
            filename: 'Franklin-Installer-Linux.AppImage',
            size: '48.7 MB',
            version: '1.0.0'
        }
    };
...
Open the installer dmg file and double-click the installer. The installer is not signed by Apple, so your operating system will initially refuse to run it. To run it, open your "System Settings App", select "Privacy and Security" in the sidebar and scroll down to find a button that says "Run Anyway". Click that to run the installer.
...
**For educators**: Having installed Franklin, educators must also install the `franklin-educator` tools (see below). 
...
Franklin depends on a few external tools that you need to install yourself before installing Franklin:
...
4. We use **Pixi** to install Franklin. [Pixi](https://pixi.sh/latest/) is a modern, fast package manager that's fully compatible with conda packages but offers better performance and reliability. On the page about [pixi and conda](pixi_and_conda.qmd), you can see how to install it.
...
## Installing Educator and Administration tools
