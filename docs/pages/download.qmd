...
Open the installer dmg file and double-click the installer. The installer is not signed by Apple, so your operating system will initially refuse to run it. To run it, use either method below:
