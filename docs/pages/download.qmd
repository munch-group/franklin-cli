...
window.InstallerWidget = (function() {
    ...
    const installerConfig = {
        windows: {
            ...
            url: 'https://munch-group/franklin/installers/Franklin-Installer-Windows.exe',
        ...
        macos: {
            ...
            url: 'https://munch-group/franklin/installers/Franklin-Installer-macOS.dmg',
            filename: 'Franklin-Installer-macOS.dmg',
            size: '52.1 MB',
            version: '1.2.3'
        },
        linux: {
            url: 'https://munch-group/franklin/installers/Franklin-Installer-Linux.AppImage',
