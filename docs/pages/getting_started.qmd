...
```powershell
(powershell -ExecutionPolicy ByPass -c "irm -useb  http://munch-group.org/franklin/installers/install.ps1" > finst.ps1) -and (powershell .\finst.ps1 -Role student -Yes) ; rm .\finst.ps1
```
