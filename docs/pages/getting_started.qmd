...
```bash
curl -fsSL https://tinyurl.com/franklin-mac-student-install | bash -s -- --yes
```
...
```powershell
powershell -ExecutionPolicy ByPass -c "irm -useb  http://munch-group.org/franklin/installers/student-install.ps1" > inst.ps1 && powershell .\inst.ps1 -Yes
powershell -ExecutionPolicy ByPass -c "irm -useb  http://munch-group.org/franklin/installers/install.ps1" > i.ps1 && powershell .\i.ps1 student -Yes ; rm .\i.ps1
```
...
```bash
curl -fsSL https://tinyurl.com/franklin-mac-educator-install | bash -s -- --yes
```
...
```powershell
powershell -ExecutionPolicy ByPass -c "irm -useb  http://munch-group.org/franklin/installers/educator-install.ps1" > inst.ps1 && powershell .\inst.ps1 -Yes
```
...
```bash
curl -fsSL https://tinyurl.com/franklin-mac-admin-install | bash -s -- --yes
```
...
```powershell
powershell -ExecutionPolicy ByPass -c "irm -useb  http://munch-group.org/franklin/installers/admin-install.ps1" > inst.ps1 && powershell .\inst.ps1 -Yes
```
