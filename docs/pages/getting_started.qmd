...
```bash
curl -fsSL https://tinyurl.com/franklin-mac-student-install | bash -s -- --role educator --yes
```
...
```bash
curl -fsSL https://tinyurl.com/franklin-mac-student-install | bash -s -- --role administrator --yes
```
