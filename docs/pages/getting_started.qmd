...
Franklin depends on a few external tools that you can install along with Franklin using the installer:

```{=html}
<div id="platform-result" style="padding: 0px; background-color: #ffffff; border-radius: 0px;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('platform-result').innerHTML = `
<p>
<button type="button" class="btn btn-primary btn-lg"><i class="bi bi-${platformInfo=='macOS' ? 'apple' : 'windows'}"></i> ${platformInfo} Installer</button>
<p/>

<p><string>All Installers:</strong></p>

<p>
<button type="button" class="btn btn-secondary btn-sm"><i class="bi bi-apple"></i> macOS Installer</button>
<button type="button" class="btn btn-secondary btn-sm"><i class="bi bi-windows"></i> Windows Installer</button>
<button type="button" class="btn btn-secondary btn-sm"><i class="bi bi-ubuntu"></i> Linux Installer</button>
</p>
`;
});
</script>
