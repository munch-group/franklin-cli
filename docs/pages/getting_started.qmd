...
<i class="bi bi-apple"></i> **Mac**: Open your Terminal application, paste the command into the Terminal window and press Enter.

```bash
curl -fsSL https://tinyurl.com/franklin-mac-student-install | bash
```

<i class="bi bi-windows"></i> **Windows**: Open your PowerShell application, paste the command into the PowerShell window and press Enter.
