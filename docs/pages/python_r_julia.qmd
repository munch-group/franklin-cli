...
- Franklin ecosystem integration
...
1. **Python (Recommended)**: Default choice for Franklin exercises
2. **R**: Use for statistics-focused courses
3. **Julia**: Use for high-performance computing courses
